...
# ABSTRACT: a plack based webinterface to Zabbix::Reporter
...
has '_plugins' => (
    'is'       => 'rw',
    'isa'      => 'HashRef[Zabbix::Reporter::Web::Plugin]',
    'lazy'     => 1,
...
sub _init_finder {
    ...
    my $Finder = Module::Pluggable::Object::->new( 'search_path' => 'Zabbix::Reporter::Web::Plugin' );
...
sub _init_tt {
    ...
    my $cfg_dir = $self->config()->get('Zabbix::Reporter::TemplatePath');
...
Zabbix::Reporter::Web - a plack based webinterface to Zabbix::Reporter
